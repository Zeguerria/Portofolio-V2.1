            ...
            <div class="col-md-12 col-lg-12 moncard entete"  >
                <div class="title pt-2">
                    <h4 class="mb-0 bread entete animate__animated animate__bounceInDown" >
                        <img src="{{asset('glbal/icon/presentation.gif')}}" alt="" class="img img-circle" width="50" height="50" style="border-radius: 50%;">
                        &ensp;Projets
                    </h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation" class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <ol class="breadcrumb naventete">
                        ...
                        <li class="breadcrumb-item active navhomet animate__animated animate__bounceInUp" aria-current="page" >Projet</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 pt-4 d-flex nav justify-content-end">
                                            <div class="form-group">
                                                <label for=""><a href="{{route('P-Projets')}}" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" title="projets total" ><i class=" fas fa-project-diagram msicons" ></i></a><sup>{{$ProjetTotal}}</sup></label>
                                                <label for=""><a href="{{route('PC-Projets')}}" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" data-placement="bottom" title="projets total en corbeille"><i class="fa fa-trash msicons" ></i></a><sup >{{$ProjetTotalC}}</sup></label>
                                            </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header moncard" >
                                                        <h4 class="modal-title fw-bold " style="font-size : 35px; font-weight: 900; ">
                                                            <span><i class="fas fa-project-diagram mesicons"></i></span>&ensp;
                                                            <span class="comming" style="font-weight: 900;">A</span>jouter un <span class="comming">P</span>rojet
                                                        </h4>
                                                    ...
                                                    <div class="modal-body" >
                                                        <form method="POST" action="{{ route('AjouterProjet') }}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div>
                                                                <div class="row">
                                                                    <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                    <div class="form-group">
                                                                        <label class="d-flex" style="font-family: italic;"><i class="fa fa-code msicons" aria-hidden="true"></i>&ensp;Nom du projet</label>
                                                                        <input type="text" class="form-control" id="" name="name" placeholder="Entrer le nom du projet">
                                                                    </div>
                                                                    </div>
                                                                    <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                        <div class="form-group">
                                ...
                                <tbody >
                                    @foreach($projets as $key => $value)
                                        <tr>
                                            ...
                                            @endif
                                            <td class="text-center">{{$value->tasks->count()}}</td>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header moncard" >
                                                                <h4 class="modal-title " style="font-size : 35px; font-weight: 900; ">
                                                                    ...
                                                                    <span class="comming" style="font-weight: 900;">C</span>onsulter le Projet : {{$value->name}}
                                                                </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                                    ...
                                                                    <div>
                                                                        <div class="row">
                                                                            <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label class="d-flex" style=" font-family: italic;"><i class="fa fa-code msicons" aria-hidden="true"></i>&ensp;Nom du projet</label>
                                                                                    <input type="text" class="form-control" value="{{$value->name}}" readonly id="consulter{{$value->id}}" name="name" placeholder="Entrer le nom du projet">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                <div class="form-group">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header moncard" >
                                                                <h4 class="modal-title " style="font-size : 35px; font-weight: 900; ">
                                                                    ...
                                                                    <span class="comming" style="font-weight: 900;">M</span>odifier le Projet : {{$value->name}}
                                                                </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            ...
                                                            <div class="modal-body" >
                                                                <form method="post" action="{{route('ModifierProjet')}}" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <input type="hidden" name="id" value="{{$value->id}}">
                                                                        <!--corp du formulaire debut-->
                                                                        <div>
                                                                            <div class="row">
                                                                                <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                    <div class="form-group">
                                                                                        <label class="d-flex" style=" font-family: italic;"><i class="fa fa-code msicons" aria-hidden="true"></i>&ensp;Nom du projet</label>
                                                                                        <input type="text" class="form-control" value="{{$value->name}}"  id="consulter{{$value->id}}" name="name" placeholder="Entrer le nom du projet">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                    <div class="form-group">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header moncard">
                                                                <h4 class="modal-title" style="font-size: 35px; font-weight: 900;">
                                                                    ...
                                                                    <span class="comming" style="font-weight: 900;">S</span>upprimer le Projet : {{$value->name}}
                                                                </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post" action="{{route('CorbeilleProjet')}}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <input type="hidden" name="id" value="{{$value->id}}">
                                                                    <!-- Reste du formulaire -->
                                                                    <div>
                                                                        <div class="row">
                                                                            <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                <div class="form-group">
                                                                                    <label class="d-flex" style=" font-family: italic;"><i class="fa fa-code msicons" aria-hidden="true"></i>&ensp;Projet</label>
                                                                                    <input type="text" class="form-control" value="{{$value->name}}" readonly id="consulter{{$value->id}}" name="name" placeholder="Entrer le npm du projet">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 col-md-12 col-ml-12 col-lg-12">
                                                                                <div class="form-group">
                                ...
                                <div class="code-box" >
                                    <div class="clearfix p-1">
                                        <div class="container-fluid pt-2">
                                            <div class="row">
                                                <div class="col" >
                                                    <a href="{{route('C-All-PJ')}}" data-bs-toggle="tooltip" title="Tout Supprimer" class="nav-link-heart btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
