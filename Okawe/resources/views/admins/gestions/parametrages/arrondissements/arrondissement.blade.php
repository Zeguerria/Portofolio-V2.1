        ...
        <div class="content-header pb-5">
            <div class="col-md-12 " style="background-image: url({{asset('glbal/theme/t7.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;" >
                <div class="title pt-2">
                    <h4 class="mb-0 bread tit"><img src="{{asset('glbal/icon/university.gif')}}" alt="" class="img img-circle " width="50" height="50">&ensp;Arrondissements</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active ti" aria-current="page" >Arrondissement</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 pt-4 d-flex nav justify-content-end">
                                            <div class="form-group">
                                                <label for=""><a href="./Arrondissements" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" title="total arrondissements" ><i class="fa fa-university mesicons" style=" font-size: 20px;"></i></a><sup>{{$ParametreTotal}}</sup></label>
                                                <label for=""><a href="./ArrondissementCorbeilles" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" data-placement="bottom" title="total arrondissements en corbeille"><i class="fa fa-trash msicons" style=" font-size: 20px;"></i></a><sup >{{$ParametreTotalC}}</sup></label>
                                            </div>
