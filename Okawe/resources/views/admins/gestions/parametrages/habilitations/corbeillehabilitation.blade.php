            ...
            <div class="col-md-12 col-lg-12 moncard entete"  >
                ...
                <nav aria-label="breadcrumb" role="navigation" class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    ...
                    <ol class="breadcrumb naventete">
                        ...
                        <li class="breadcrumb-item active navhomet animate__animated animate__bounceInUp" aria-current="page" >Habilitation</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 pt-4 d-flex nav justify-content-end">
                                            <div class="form-group">
                                                <label for=""><a href="{{route('H-Habilitations')}}" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" title="habilitations total" ><i class=" fab fa-500px msicons" ></i></a><sup>{{$HabilitationT}}</sup></label>
                                                <label for=""><a href="{{route('HC-Habilitations')}}" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" data-placement="bottom" title="habilitations total en corbeille"><i class="fa fa-trash msicons" ></i></a><sup >{{$HabilitationTC}}</sup></label>
                                            </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header moncard" >
                                                                        <h4 class="modal-title " style="font-size : 35px; font-weight: 900; ">
                                                                            ...
                                                                            <span class="comming" style="font-weight: 900;">C</span>onsulter l'Habilitation : {{$value->libelle}}
                                                                        </h4>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header moncard" >
                                                                        <h4 class="modal-title " style="font-size : 35px; font-weight: 900; ">
                                                                            ...
                                                                            <span class="comming" style="font-weight: 900;">R</span>estorer l'Habilitation : {{$value->libelle}}
                                                                        </h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    ...
                                                                    <div class="modal-body" >
                                                                        <form method="post" action="{{route('RecupHabilitation')}}" enctype="multipart/form-data">
                                                                                @csrf
                                                                                <input type="hidden" name="id" value="{{$value->id}}">
                                                                                <!--corp du formulaire debut-->
                                                                                <div>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header moncard">
                                                                        <h4 class="modal-title" style="font-size: 35px; font-weight: 900;">
                                                                            ...
                                                                            <span class="comming" style="font-weight: 900;">S</span>upprimer l'Habilitation : {{$value->libelle}}
                                                                        </h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="{{route('SupprimerHabilitation')}}" enctype="multipart/form-data">
                                                                            @csrf
                                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                                            <!-- Reste du formulaire -->
                                                                            <div>
                                ...
                                <div class="code-box" >
                                    <div class="clearfix p-1">
                                        <div class="container-fluid pt-2">
                                            <div class="row">
                                                    <div class="col" >
                                                        <a href="{{route('D-All-HU')}}" data-bs-toggle="tooltip" title="Tout Vider" class="nav-link-heart btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
                                                        <a href="{{route('R-All-HU')}}" data-bs-toggle="tooltip" title="Tout Restorer" data-placement="bottom" class="nav-link-heart btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp;
                                                    </div>
