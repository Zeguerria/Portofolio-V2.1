            ...
            <div class="col-md-12 col-lg-12 moncard entete"  >
                <div class="title pt-2">
                    <h4 class="mb-0 bread entete animate__animated animate__bounceInDown" >
                        <img src="{{asset('glbal/icon/repair-tools.gif')}}" alt="" class="img img-circle" width="50" height="50" style="border-radius: 50%;">
                        &ensp;Types de Paramètre
                    </h4>
                </div>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header moncard" >
                                                        <h4 class="modal-title fw-bold " style="font-size : 35px; font-weight: 900; ">
                                                            ...
                                                            <span class="comming" style="font-weight: 900;">A</span>jouter un <span class="comming">T</span>ype de<span class="comming">P</span>aramètre
                                                        </h4>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header moncard" >
                                                                <h4 class="modal-title " style="font-size : 35px; font-weight: 900; ">
                                                                    ...
                                                                    <span class="comming" style="font-weight: 900;">M</span>odifier le Type de Paramètre : {{$value->libelle}}
                                                                </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header moncard">
                                                                <h4 class="modal-title" style="font-size: 35px; font-weight: 900;">
                                                                    ...
                                                                    <span class="comming" style="font-weight: 900;">S</span>upprimer le Type Paramètre : {{$value->libelle}}
                                                                </h4>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color: #B460B5;">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                ...
                                <div class="code-box" >
                                    <div class="clearfix p-1">
                                        <div class="container-fluid pt-2">
                                            <div class="row">
                                                <div class="col" >
                                                    <a href="{{route('C-All-TP')}}" data-bs-toggle="tooltip" title="Tout Supprimer" class="nav-link-heart btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
