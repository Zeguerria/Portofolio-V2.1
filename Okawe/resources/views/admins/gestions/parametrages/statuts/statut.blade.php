        ...
        <div class="content-header pb-5">
            <div class="col-md-12 " style="background-image: url({{asset('glbal/theme/t7.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;" >
                <div class="title pt-2">
                    <h4 class="mb-0 bread tit" ><img src="{{asset('glbal/icon/eye-protection.gif')}}" alt="" class="img img-circle " width="50" height="50">&ensp;Statuts</h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active t" aria-current="page" >Parétrages</li>
                        <li class="breadcrumb-item active ti" aria-current="page"  >Statut</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-header moncard" >
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col">
                                            <button class="btn nav-link-heart nav-link-heart" data-bs-toggle="tooltip" title="Ajouter" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus msicons" style="font-size: 30px; color:#7bff00;"></i></button>
                                            {{-- MODAL AJOUTER DEBUT --}}
                                                    ...
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header bgnav" style="background-image: url({{asset('glbal/theme/t7.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                <h4 class="modal-title fw-bold titre-grandiant" style="font-size : 35px; font-weight: 900; "><span><i class="fas fa-list-ol"></i></span>&ensp;Ajouter un Statut</h4>
                                        ...
                                        <div class="col-md-9 pt-4 d-flex nav justify-content-end">
                                            <div class="form-group">
                                                <label for=""><a href="./Statuts" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" title="total statuts" ><i class="fas  fa-list-ol mesicons" style=" font-size: 20px;"></i></a><sup >{{$ParametreTotal}}</sup></label>
                                                <label for=""><a href="./StatutCorbeilles" class="btn nav-link-heart" id="" data-bs-toggle="tooltip" data-placement="bottom" title="total statuts en corbeille"><i class="fa fa-trash msicons" style=" font-size: 20px;"></i></a><sup  nav-link-heart>{{$ParametreTotalC}}</sup></label>
                                            </div>
